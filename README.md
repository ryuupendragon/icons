...
Selfhosted Icon server build code and most of the icons from [Selfhst](https://github.com/selfhst/icons), Please check their [LICENSE](https://raw.githubusercontent.com/selfhst/icons/refs/heads/main/LICENSE) for them.
